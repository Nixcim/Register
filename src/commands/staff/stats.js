...
module.exports = {
    ...
    aliases: ['stat', 'me'],
    category: 'Yetkili',
    usage: '<@Mikey./ID> [günlük / haftalık / aylık / tümzamanlar]', 
    staff: true,
    guildOnly: true,
    cooldown: 3,
...
\`•>\` Şimdiye Kadar Toplam Kayıtsıza Atma Sayı : **${userData.unregister}**
            ...
            } else return message.channel.error(message, Embed.setDescription(`${mark ? mark : ``} Doğru kullanım : \`${Prefix}stats <@Mikey./ID> [günlük / haftalık / aylık / tümzamanlar]\``), { timeout: 10000, react: true });
